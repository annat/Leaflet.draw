L.Polyline.Draw = L.Handler.Draw.extend({
	...
	addHooks : function() {
		...
		if (this._map) {
			...
			this._map.on('mousemove', this._onMouseMove, this).on('click', this._onClick, this);

			this._poly.on('click', this._onPolyClick, this);
		}
	},
	...
	removeHooks : function() {
		...
		// this._map.off('mousemove', this._onMouseMove).off('click', this._onClick);
	},
	...
	_finishShape : function() {
		...
		this.waitingForEdit = true;

		// TODO make markers invisible
	...
	_onMouseMove : function(e) {
		var newPos = e.layerPoint, latlng = e.latlng, markerCount = this._markers.length;
	...
	_onClick : function(e) {
		...
		if (!this.editMode) {
			var latlng = e.latlng, markerCount = this._markers.length;
	...
	_onPolyClick : function(e) {

		
		if (this.waitingForEdit) {
	...
	_showErrorLabel : function() {
		...
		L.Handler.Draw.prototype._updateLabelText.call(this, {
